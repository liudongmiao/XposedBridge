 ...
 */
public final class XSharedPreferencesHC implements SharedPreferences {
	...
	public XSharedPreferencesHC(File prefFile) {
		mFile = prefFile;
		startLoadFromDisk();
    }
	
	public XSharedPreferencesHC(String packageName) {
		this(packageName, packageName + "_preferences");
    }
	
	public XSharedPreferencesHC(String packageName, String prefFileName) {
    ...
    private void startLoadFromDisk() {
        ...
        new Thread("XSharedPreferences-load") {
            @Override
            public void run() {
                synchronized (XSharedPreferencesHC.this) {
                    loadFromDiskLocked();
                }
            }
        }.start();
